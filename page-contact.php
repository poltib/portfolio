...
<?php if(have_posts()): ?>
	...
	<section class="hi">
		<div id="svgAnim">
				...
				<path id="i0" fill="none" stroke="#000000" stroke-miterlimit="10" d="M360,18.25c0,0-23.792,6.542-29.042,7.042s-30.48,4.979-30.48,4.979
					...
					l-34.25,6.583"/>
				<path id="i1" fill="none" stroke="#000000" stroke-miterlimit="10" d="M189.166,137.793l-2.041,1.52L186,140.5h-3.25l0.062-1.938l4.5,0.125
				...
				<path id="i2" fill="none" stroke="#000000" stroke-miterlimit="10" d="M297.658,36.224l-21.908,5.794l-2.373-2.8L267.5,40v12
				...
				<path id="i3" fill="none" stroke="#000000" stroke-miterlimit="10" d="M-0.297,89.802l11.023-4.651l-10.801,12.8l0.5,21.963l0.806-12.582
				...
				<path id="i4" fill="none" stroke="#000000" stroke-miterlimit="10" d="M3.708,139.333l-4.104-0.667L0.917,127.5H5l2.25-2.25
					...
					l8.584-0.666"/>
				<path id="i5" fill="none" stroke="#000000" stroke-miterlimit="10" d="M238.631,83.771L225.038,85l1.793-6.125l2.022,5l1.073-1.938
				...
				<path id="i6" fill="none" stroke="#000000" stroke-miterlimit="10" d="M195.688,21.062l-1.42-5.75c0,0-0.08-2.812,1.42-3.375
	...
	<section class="hi contact">
		<div class="text">
			<h3 role="heading" aria-level="3"><?php _e( 'Coordonnées', 'portfolio' ); ?></h3>
			<ul class="vcard" itemscope itemtype="http://schema.org/Person">
				<li class="fn" itemprop="name"><i class="icon-user-1"></i> <?php the_field('prenom') ?>&nbsp;<?php the_field('nom') ?></li>
				<li class="email" itemprop="email"><i class="icon-mail-1"></i> <a href="mailto:<?php the_field('adresse_e-mail') ?>"><?php the_field('adresse_e-mail') ?></a></li>
				<li class="tel" itemprop="telephone"><i class="icon-phone-1"></i> <?php the_field('numero_de_telephone') ?></li>
				<li class="adr" itemprop="address"><i class="icon-location-1"></i> 
